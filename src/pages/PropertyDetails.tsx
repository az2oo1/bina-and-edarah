                  ...
                  <div className="p-4 flex-1 flex flex-col justify-between">
                    ...
                    <div className="mt-4 pt-3 border-t border-border/40 flex items-center justify-between gap-3">
                      ...
                      <Link
                        ...
                        className="btn-primary text-xs h-8 px-3.5 gap-1.5 active:scale-[0.97]"
                      >
            ...
            <div className="shadcn-card p-6">
              ...
              <div className="flex flex-col gap-2 pt-2">
                <a
                  ...
                  className="btn-primary w-full text-xs h-10 justify-center gap-1.5 active:scale-[0.97] transition-all cursor-pointer shadow-md"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full inline-flex items-center justify-center rounded-full text-xs font-semibold bg-[#25D366] text-white hover:bg-[#22bf5b] h-10 px-4 py-2 transition-all duration-150 ease-out active:scale-[0.97] cursor-pointer gap-1.5 shadow-md"
                >
