              ...
              <div className="mb-6 pb-6 border-b border-border">
                ...
                {property.type === 'RENT' && property.paymentFrequency && (
                  <div className="flex gap-1.5 mb-4">
                    <p className="text-xs text-foreground bg-slate-100 rounded px-2.5 py-1 font-semibold flex items-center gap-1.5">
                ...
                <div className="space-y-2.5 p-4 bg-background rounded-lg border border-border">
                  ...
                  <div className="flex justify-between items-center text-xs font-medium">
                    ...
                    <span className="text-foreground text-left flex items-center gap-0.5" dir="ltr">
                      {property.vat > 0 ? <>{property.vat.toLocaleString()} <SrIcon className="w-3.5 h-3.5 text-muted-foreground/60" /></> : (language === 'ar' ? 'شامل' : 'Included')}
                    </span>
                  </div>
                  {property.type === 'RENT' && (
                    <div className="flex justify-between items-center text-xs font-medium">
