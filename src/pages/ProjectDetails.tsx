              ...
              <div className="shadcn-card p-6 relative overflow-hidden">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full inline-flex items-center justify-center rounded-full text-xs font-semibold bg-[#25D366] text-white hover:bg-[#22bf5b] h-9 px-4 py-2 shadow-xs transition-all duration-150 ease-out active:scale-97 cursor-pointer gap-1.5"
                  >
