            ...
            projects.map((project, idx) => (
              ...
              >
                ...
                <div className="px-4 py-3 bg-muted/40 border-t border-border flex justify-between items-center">
                  <button onClick={() => handleDelete(project.id)} className="text-red-500 hover:text-red-600 p-2 hover:bg-red-500/10 rounded-lg transition-transform active:scale-[0.97] cursor-pointer" aria-label={language === 'ar' ? 'حذف المشروع' : 'Delete Project'}>
                    <Trash2 className="w-5 h-5" />
                  </button>
