...
export function FloatingWhatsApp({ phoneNumber = '966556467063' }: FloatingWhatsAppProps) {
  ...
  return (
    <motion.aside
      ...
      className="fixed bottom-8 right-8 sm:bottom-10 sm:right-10 z-40 flex items-center"
    ...
    >
      <a
        ...
        className="inline-flex items-center justify-center gap-2 rounded-full font-semibold text-sm px-5 py-2.5 bg-[#25D366] hover:bg-[#20bd5a] text-white border border-transparent transition-all duration-200 ease-out cursor-pointer select-none shadow-none hover:scale-110 active:scale-[0.97] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-900"
      >
