...
export const SnapIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2c-3.7 0-6 2.5-6 5.5 0 2.2 1.6 3.6 3.3 4.1-.3.5-1 .9-1.9.9H7.1c-.8 0-1.4.5-1.6 1.2-.2.7.2 1.4.9 1.7 1.6.7 3 2.1 3 3.6 0 1.1-.9 2-2 2h-.4c-.8 0-1.4.5-1.6 1.2-.2.7.2 1.4.9 1.7C8 24 9.5 24 11 24h2c1.5 0 3 0 4.7-.2.7-.3 1.1-1 .9-1.7-.2-.7-.8-1.2-1.6-1.2h-.4c-1.1 0-2-.9-2-2 0-1.5 1.4-2.9 3-3.6.7-.3 1.1-1 .9-1.7-.2-.7-.8-1.2-1.6-1.2h-.3c-.9 0-1.6-.4-1.9-.9 1.7-.5 3.3-1.9 3.3-4.1C18 4.5 15.7 2 12 2z"/>
  </svg>
);
